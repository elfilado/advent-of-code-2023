package day.one.second.exercise;

import java.util.Scanner;

public class Main {

    static String input = "8eight1\n" +
            "98126\n" +
    ...
    public static void main(String[] args) {
        input = input.replaceAll("eightwo", "8wo");
        input = input.replaceAll("twone", "2ne");
        input = input.replaceAll("oneight", "1ight");
        input = input.replaceAll("sevenine", "7ine");
        input = input.replaceAll("nineight", "9ight");
